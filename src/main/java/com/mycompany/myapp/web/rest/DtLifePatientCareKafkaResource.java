...
@RestController
@RequestMapping("/api/dt-life-patient-care-kafka")
public class DtLifePatientCareKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DtLifePatientCareKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DtLifePatientCareKafkaResource(KafkaProperties kafkaProperties) {
