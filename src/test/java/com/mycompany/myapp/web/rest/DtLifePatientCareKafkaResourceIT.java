...
class DtLifePatientCareKafkaResourceIT {
    ...
    void setup() {
        ...
        DtLifePatientCareKafkaResource kafkaResource = new DtLifePatientCareKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/dt-life-patient-care-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/dt-life-patient-care-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
